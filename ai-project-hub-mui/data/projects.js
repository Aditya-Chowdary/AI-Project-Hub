...
export const projects = [
  // 1. AI-Powered Freelance Marketplace
  {
    ...
    imageUrl: '/images/project-freelance.jpg',
  ...
  // 2. AI Video Sales Letter Creator
  {
    slug: 'ai-video-sales-creator',
  ...
  // 4. AI-Generated Virtual Employees
  {
    ...
    imageUrl: '/images/project-virtual-employee.jpg',
  ...
  // 5. AI Meeting Summarizer Agent
  {
    ...
    imageUrl: '/images/project-meeting.jpg',
  ...
  // 6. AI CRM Follow-Up Agent
  {
    slug: 'ai-crm-follow-up',
    ...
    imageUrl: '/images/project-crm.jpg',
  ...
  // 7. AI Financial Forecasting Assistant
  {
  ...
  // 8. AI Inbox Zero Agent
  {
    ...
    imageUrl:'./public/images/FinancialForecast.png',  
  ...
  // 9. AI Client Onboarding Bot
  {
    ...
    imageUrl: '/images/project-onboarding.jpg',
